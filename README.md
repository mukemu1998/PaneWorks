...
<p align="center">
  ...
  <img alt="Version 0.2.6" src="https://img.shields.io/badge/Version-0.2.6-22c55e" />
...
artifacts/
  releases/
    v0.2.6/
      PaneWorks-v0.2.6-win-x64-portable.zip
      PaneWorks-v0.2.6-win-x64-portable.zip.sha256
      PaneWorks-v0.2.6-win-x64-portable/
        PaneWorks.exe
        README.md
        LICENSE
        VERSION
...
当前公开版本为 `0.2.6`。用户自建布局、工作区方案与个人设置保存在 `%AppData%\PaneWorks\`，不会写入仓库源码目录。
