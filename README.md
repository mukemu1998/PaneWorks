...
<p align="center">
  ...
  <img alt="Version 0.2.7" src="https://img.shields.io/badge/Version-0.2.7-22c55e" />
...
| 临时拓扑吸附 | 工作中拖出的窗口会释放当前边界；剩余窗口拖边靠近相邻窗口或屏幕平行线时，可重新吸附并恢复联动。 |
...
artifacts/
  releases/
    v0.2.7/
      PaneWorks-v0.2.7-win-x64-portable.zip
      PaneWorks-v0.2.7-win-x64-portable.zip.sha256
      PaneWorks-v0.2.7-win-x64-portable/
        PaneWorks.exe
        README.md
        LICENSE
        VERSION
...
当前公开版本为 `0.2.7`。用户自建布局、工作区方案与个人设置保存在 `%AppData%\PaneWorks\`，不会写入仓库源码目录。
