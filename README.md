...
artifacts/
  releases/
    v0.3.2/
      PaneWorks-v0.3.2-win-x64-portable.zip
      PaneWorks-v0.3.2-win-x64-portable.zip.sha256
      PaneWorks-v0.3.2-win-x64-portable/
        PaneWorks.exe
        README.md
        LICENSE
        VERSION
...
当前公开版本为 `0.3.2`。用户自建布局、工作区方案与个人设置保存在 `%AppData%\PaneWorks\`，不会写入仓库源码目录。
