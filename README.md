...
<p align="center">
  ...
  <img alt="Version 0.2.4" src="https://img.shields.io/badge/Version-0.2.4-22c55e" />
</p>
...
artifacts/
  releases/
    v0.2.4/
      PaneWorks-v0.2.4-win-x64-portable.zip
      PaneWorks-v0.2.4-win-x64-portable.zip.sha256
      PaneWorks-v0.2.4-win-x64-portable/
        PaneWorks.exe
        README.md
        VERSION
```
...
当前开发版本为 `0.2.4`，处于原型打磨与持续迭代阶段。用户自建布局、工作区方案与个人设置保存在 `%AppData%\PaneWorks\`，不会写入仓库源码目录。
